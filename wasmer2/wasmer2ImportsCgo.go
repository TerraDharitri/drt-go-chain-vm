...
// extern void      w2_managedGetDCDTTokenType(void* context, int32_t addressHandle, int32_t tokenIDHandle, long long nonce, int32_t typeHandle);
...
// extern int32_t   w2_managedMultiTransferDCDTNFTExecuteWithReturn(void* context, int32_t dstHandle, int32_t tokenTransfersHandle, long long gasLimit, int32_t functionHandle, int32_t argumentsHandle);
...
func populateCgoFunctionPointers() *cWasmerVmHookPointers {
	return &cWasmerVmHookPointers{
		...
		managed_get_dcdt_token_type_func_ptr:                         funcPointer(C.w2_managedGetDCDTTokenType),
		...
		managed_multi_transfer_dcdt_nft_execute_with_return_func_ptr: funcPointer(C.w2_managedMultiTransferDCDTNFTExecuteWithReturn),
...
//export w2_managedGetDCDTTokenType
func w2_managedGetDCDTTokenType(context unsafe.Pointer, addressHandle int32, tokenIDHandle int32, nonce int64, typeHandle int32) {
	vmHooks := getVMHooksFromContextRawPtr(context)
	vmHooks.ManagedGetDCDTTokenType(addressHandle, tokenIDHandle, nonce, typeHandle)
}
...
//export w2_managedMultiTransferDCDTNFTExecuteWithReturn
func w2_managedMultiTransferDCDTNFTExecuteWithReturn(context unsafe.Pointer, dstHandle int32, tokenTransfersHandle int32, gasLimit int64, functionHandle int32, argumentsHandle int32) int32 {
	vmHooks := getVMHooksFromContextRawPtr(context)
	return vmHooks.ManagedMultiTransferDCDTNFTExecuteWithReturn(dstHandle, tokenTransfersHandle, gasLimit, functionHandle, argumentsHandle)
}
